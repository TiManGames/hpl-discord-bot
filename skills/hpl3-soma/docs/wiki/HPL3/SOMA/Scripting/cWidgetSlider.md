...
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetBarClickValueAdd ||   ||
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetBarValueSize ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetButtonSize ||   ||
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetButtonValueAdd ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetMaxValue ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetValue ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetBarClickValueAdd || <syntaxhighlight lang="c++" inline>int alAdd</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetBarValueSize || <syntaxhighlight lang="c++" inline>int alSize</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetButtonValueAdd || <syntaxhighlight lang="c++" inline>int alAdd</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetMaxValue || <syntaxhighlight lang="c++" inline>int alMax</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetValue || <syntaxhighlight lang="c++" inline>int alValue</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abGenCallback = true</syntaxhighlight> ||
|-
