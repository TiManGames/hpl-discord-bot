...
cWidgetContextMenu has no public fields.
...
|-
| [[../cWidgetMenuItem|<syntaxhighlight lang="c++" inline>cWidgetMenuItem@</syntaxhighlight>]] || AddMenuItem || [[../tWString|<syntaxhighlight lang="c++" inline>const tWString &in asText</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || AddSeparator ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || ClearMenuItems ||   ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || ClipsGraphics ||   ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetArrowOffset ||   ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetCallbacksDisabled ||  ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetCheckOffset ||   ||
|-
...
|-
| [[../cWidgetMenuItem|<syntaxhighlight lang="c++" inline>cWidgetMenuItem@</syntaxhighlight>]] || GetHighlightedItem ||   ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetLocalPosition ||  ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetMenuItemWidth ||   ||
|-
...
|-
| [[../cWidgetMenuItem|<syntaxhighlight lang="c++" inline>cWidgetMenuItem@</syntaxhighlight>]] || GetParentItem ||   ||
|-
| [[../iWidgetMenu|<syntaxhighlight lang="c++" inline>iWidgetMenu@</syntaxhighlight>]] || GetParentMenu ||   ||
|-
...
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetTextOffset ||   ||
|-
...
|-
| [[../iWidgetMenu|<syntaxhighlight lang="c++" inline>iWidgetMenu@</syntaxhighlight>]] || GetTopMostMenu ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || Hide ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || IsSubmenuOpen ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SavePrevAttentionWidget ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetArrowPos || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetCheckPos || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetHighlightedItem || [[../cWidgetMenuItem|<syntaxhighlight lang="c++" inline>cWidgetMenuItem@ apItem</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetMustHide || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetParentItem || [[../cWidgetMenuItem|<syntaxhighlight lang="c++" inline>cWidgetMenuItem@ apParentItem</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetPrevAttention || [[../iWidget|<syntaxhighlight lang="c++" inline>iWidget@ apWidget</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetTextPos || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]] ||
|-
