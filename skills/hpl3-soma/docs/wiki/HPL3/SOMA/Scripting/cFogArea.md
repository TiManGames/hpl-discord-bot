...
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetEnd ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetFalloffExp ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetShowBacksideWhenInside ||   ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetShowBacksideWhenOutside ||   ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetSize ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetStart ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetColor || [[../cColor|<syntaxhighlight lang="c++" inline>const cColor &in aCol</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetEnd || <syntaxhighlight lang="c++" inline>float afX</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetFalloffExp || <syntaxhighlight lang="c++" inline>float afX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetShowBacksideWhenInside || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetShowBacksideWhenOutside || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetStart || <syntaxhighlight lang="c++" inline>float afX</syntaxhighlight> ||
|-
