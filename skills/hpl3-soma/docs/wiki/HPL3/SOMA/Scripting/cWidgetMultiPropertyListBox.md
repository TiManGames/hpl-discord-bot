...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || AddColumn || [[../tString|<syntaxhighlight lang="c++" inline>const tString &in asName</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>const int alIndex</syntaxhighlight>,<br />[[../eFontAlign|<syntaxhighlight lang="c++" inline>eFontAlign aAlign = eFontAlign_Left</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetColumnWidth || <syntaxhighlight lang="c++" inline>int alIdx</syntaxhighlight> ||
|-
...
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || GetItemPosOnList || [[../cWidgetItem|<syntaxhighlight lang="c++" inline>cWidgetItem@ apItem</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>int alColumn</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || GetItemStartPos ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetColumnWidth || <syntaxhighlight lang="c++" inline>const int alIdx</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afWidth</syntaxhighlight> ||
|-
