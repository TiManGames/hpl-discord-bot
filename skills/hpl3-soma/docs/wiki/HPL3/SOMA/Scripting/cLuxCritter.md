...
|-
| mbWallAvoidDetected || <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> ||
|-
| mfForwardRotationYOffset || <syntaxhighlight lang="c++" inline>float</syntaxhighlight> ||
|-
| mfMaxGravityVelocity || <syntaxhighlight lang="c++" inline>float</syntaxhighlight> ||
|-
| mfMaxTurnSpeed || <syntaxhighlight lang="c++" inline>float</syntaxhighlight> ||
|-
| mfMaxVelocity || <syntaxhighlight lang="c++" inline>float</syntaxhighlight> ||
|-
| mfTurnSpeedMul || <syntaxhighlight lang="c++" inline>float</syntaxhighlight> ||
|-
| mlAnimState || <syntaxhighlight lang="c++" inline>int</syntaxhighlight> ||
|-
| msIdleAnim || [[../tString|<syntaxhighlight lang="c++" inline>tString</syntaxhighlight>]] ||
|-
| msMoveAnim || [[../tString|<syntaxhighlight lang="c++" inline>tString</syntaxhighlight>]] ||
|-
| mvGravityVel || [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] ||
|-
| mvGroundNormal || [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] ||
|-
| mvWallAvoidNormal || [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] ||
|-
| mvWallAvoidPosition || [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] ||
|-
| mvWantedVel || [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] ||
|}
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || DoDamageBox || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avSize</syntaxhighlight>]],<br />[[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avLocalOffset</syntaxhighlight>]],<br />[[../cVector2f|<syntaxhighlight lang="c++" inline>const cVector2f &in avMinMaxDamage</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>float afForce</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afMaxImpulse</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>int aDamageType</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afHitSpeed = 2</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>int alStrength = 0</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abCheckAgents = false</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abCheckPlayer = true</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abCheckProps = true</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abLethalForPlayer = true</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetAlignToGround ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetAngleToPlayer2D ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetAngleToPlayer3D ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetAngleToPos2D || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetAngleToPos3D || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetCanRunOnWalls ||   ||
|-
...
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetDebugEyeRay || <syntaxhighlight lang="c++" inline>int alIdx</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetDebugEyeRaysNum ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetDistanceToGround || <syntaxhighlight lang="c++" inline>float afMaxTestDistance</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abCheckDynamic</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>int alNumOfRays = 1</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afRadius = 0.25</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abGetShortest = true</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || GetDistanceToGround || [[../tString|<syntaxhighlight lang="c++" inline>const tString &in asCallbackFunc</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>float afMaxTestDistance</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abCheckDynamic</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>int alNumOfRays = 1</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afRadius = 0.25</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>bool abGetClosest = true</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetDistanceToPlayer ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetDistanceToPlayer2D ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetDistanceToPos || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetDistanceToPos2D || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetEntityIsInPlayerFOV ||   ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetEntityIsInPlayerLineOfSight || <syntaxhighlight lang="c++" inline>bool abCheckFOV</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || GetEntityIsInPlayerLineOfSight || [[../tString|<syntaxhighlight lang="c++" inline>const tString &in asCallbackFunc</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>bool abCheckFOV</syntaxhighlight> ||
|-
...
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || GetEyePostion ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetNotRenderedCount ||   ||
|-
...
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || GetPlayerFeetPos ||   ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || GetPlayerHeadPos ||   ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetPlayerIsInFOV || <syntaxhighlight lang="c++" inline>float afFOV</syntaxhighlight>,<br />[[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f& avForward</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetPlayerIsInLineOfSight || <syntaxhighlight lang="c++" inline>float afFOV</syntaxhighlight>,<br />[[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f& avForward</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>bool abCheckFOV</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetPlayerIsInLineOfSight ||   ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || GetPlayerIsInLineOfSight || [[../tString|<syntaxhighlight lang="c++" inline>const tString &in asCallbackFunc</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>float afFOV</syntaxhighlight>,<br />[[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f& avForward</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>bool abCheckFOV</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || GetPlayerIsInLineOfSight || [[../tString|<syntaxhighlight lang="c++" inline>const tString &in asCallbackFunc</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetPlayerMovementTowardEntity ||   ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetPlayerPos ||   ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetPointIsInFOV || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPoint</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>float afFOV</syntaxhighlight>,<br />[[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f& avForward</syntaxhighlight>]] ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || GetPosition ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetRelativeEyeHeight ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetUseRayCollision ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || IsFlying ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || Move_ChangeMaxSpeed || <syntaxhighlight lang="c++" inline>float afGoal</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afAcc</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetFlockingAdd || <syntaxhighlight lang="c++" inline>float afCenterMul</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afCenterYMul</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afSeparationMul</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afAlignmentMul</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afCohesionMul</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>int alMaxMemberChecks</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetStopAdd || <syntaxhighlight lang="c++" inline>float afAmount</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetTowardCenterAdd || <syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetTowardPlayerAdd || <syntaxhighlight lang="c++" inline>bool abNormalize</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetTowardPosAdd || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPos</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>bool abNormalize</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetTowardsGroundAdd || <syntaxhighlight lang="c++" inline>float afMaxHeight</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetWallAvoidAdd || <syntaxhighlight lang="c++" inline>float afDistanceForward</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetWanderAdd2D || <syntaxhighlight lang="c++" inline>float afLength</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afRadius</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_GetWanderAdd3D || <syntaxhighlight lang="c++" inline>float afLength</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afRadius</syntaxhighlight>,<br /><syntaxhighlight lang="c++" inline>float afTimeStep</syntaxhighlight> ||
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>cVector3f</syntaxhighlight>]] || Move_Normalize || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f& avVec</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetAlignToGround || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetCanRunOnWalls || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetGroup || [[../tString|<syntaxhighlight lang="c++" inline>const tString &in asEntityName</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetGroup || [[../iLuxEntity|<syntaxhighlight lang="c++" inline>iLuxEntity@ apEntity</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetIsFlying || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetRelativeEyeHeight || <syntaxhighlight lang="c++" inline>float afX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetUseRayCollision || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
