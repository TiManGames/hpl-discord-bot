...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || FadeIrradianceSet || [[../tString|<syntaxhighlight lang="c++" inline>const tString &in asSetName</syntaxhighlight>]],<br /><syntaxhighlight lang="c++" inline>float afTime</syntaxhighlight> ||
|-
...
|-
| [[../cColor|<syntaxhighlight lang="c++" inline>const cColor&</syntaxhighlight>]] || GetAmbientColorGround ||   ||
|-
| [[../cColor|<syntaxhighlight lang="c++" inline>const cColor&</syntaxhighlight>]] || GetAmbientColorSky ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetBevel ||   ||
|-
| [[../eLightBoxBlendFunc|<syntaxhighlight lang="c++" inline>eLightBoxBlendFunc</syntaxhighlight>]] || GetBlendFunc ||   ||
|-
...
|-
| [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f&</syntaxhighlight>]] || GetProbeOffset ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || GetUseSphericalHarmonics ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetWeight ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetAmbientColorGround || [[../cColor|<syntaxhighlight lang="c++" inline>const cColor& aColor</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetAmbientColorSky || [[../cColor|<syntaxhighlight lang="c++" inline>const cColor& aColor</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetBevel || <syntaxhighlight lang="c++" inline>float afX</syntaxhighlight> ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetBlendFunc || [[../eLightBoxBlendFunc|<syntaxhighlight lang="c++" inline>eLightBoxBlendFunc aFunc</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetProbeOffset || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avPosition</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetSize || [[../cVector3f|<syntaxhighlight lang="c++" inline>const cVector3f &in avSize</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetUseSphericalHarmonics || <syntaxhighlight lang="c++" inline>bool abX</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetWeight || <syntaxhighlight lang="c++" inline>float afX</syntaxhighlight> ||
|-
