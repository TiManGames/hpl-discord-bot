...
{{CodeDocDetailTop|cScene_FadeGradingTexture}}
<syntaxhighlight lang="c++">void cScene_FadeGradingTexture(cWorld@ apWorld,
                               iTexture@ apGrading,
                               float afTime)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|apWorld|[[../../cWorld|cWorld@]]|}}
{{CodeDocDetailParam|apGrading|[[../../iTexture|iTexture@]]|}}
