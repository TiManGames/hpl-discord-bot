...
{{CodeDocDetailTop|cEngine_GetWaitIfAppOutOfFocus}}
<syntaxhighlight lang="c++">bool cEngine_GetWaitIfAppOutOfFocus()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
<syntaxhighlight lang="c++">void cEngine_SetUpdatesPerSec(int alUpdatesPerSec)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|cEngine_SetWaitIfAppOutOfFocus}}
<syntaxhighlight lang="c++">void cEngine_SetWaitIfAppOutOfFocus(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
