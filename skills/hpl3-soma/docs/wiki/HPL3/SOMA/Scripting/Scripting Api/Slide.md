...
{{CodeDocDetailParam|asName|[[../../tString|tString]]|name of the prop.}}
{{CodeDocDetailParam|afAmount|float|the slide amount to set.}}
...
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|asName|[[../../tString|tString]]|name of the prop.}}
{{CodeDocDetailReturn|float|the slide amount.}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|asName|[[../../tString|tString]]|name of the prop.}}
{{CodeDocDetailReturn|cVector3f|the vel of the slide joint.}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|asName|[[../../tString|tString]]|name of the prop.}}
{{CodeDocDetailParam|abLocked|bool|if the slide prop should be locked or not.}}
{{CodeDocDetailParam|abEffects|bool|if sounds and any other effects associated with locking/unlocking should be activated}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
