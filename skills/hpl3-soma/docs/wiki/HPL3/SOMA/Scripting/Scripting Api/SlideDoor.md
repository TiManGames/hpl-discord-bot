...
{{CodeDocDetailReturn|float|open amount of the door.}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailParam|abInstant|bool|if the door should slide to the correct state or just have the}}
...
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|asName|[[../../tString|tString]]|name of the door.}}
{{CodeDocDetailParam|abX|bool|if possible to open or not.}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|asName|[[../../tString|tString]]|name of the door.}}
{{CodeDocDetailParam|afOpenAmount|float|the open amount to set}}
{{CodeDocDetailParam|abInstant|bool|if the door should slide to the correct state or just have the}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}