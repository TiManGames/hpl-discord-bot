...
|-
| [[../cWidgetTab|<syntaxhighlight lang="c++" inline>cWidgetTab@</syntaxhighlight>]] || AddTab || [[../tWString|<syntaxhighlight lang="c++" inline>const tWString &in asTabCaption</syntaxhighlight>]] ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || ClearTabs ||   ||
|-
| <syntaxhighlight lang="c++" inline>bool</syntaxhighlight> || ClipsGraphics ||   ||
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetBackgroundZ ||   ||
|-
...
|-
| [[../cWidgetTab|<syntaxhighlight lang="c++" inline>cWidgetTab@</syntaxhighlight>]] || GetFocusedTab ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>float</syntaxhighlight> || GetForegroundZ ||   ||
|-
...
|-
| [[../cWidgetTab|<syntaxhighlight lang="c++" inline>cWidgetTab@</syntaxhighlight>]] || GetTab || <syntaxhighlight lang="c++" inline>int alIdx</syntaxhighlight> ||
|-
| [[../cWidgetTab|<syntaxhighlight lang="c++" inline>cWidgetTab@</syntaxhighlight>]] || GetTab || [[../tWString|<syntaxhighlight lang="c++" inline>const tWString &in asTabCaption</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetTabNum ||   ||
|-
| <syntaxhighlight lang="c++" inline>int</syntaxhighlight> || GetTabOnTopIndex ||   ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetBackgroundZ || <syntaxhighlight lang="c++" inline>float afZ</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetFocusedTab || [[../cWidgetTab|<syntaxhighlight lang="c++" inline>cWidgetTab@ apTab</syntaxhighlight>]] ||
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetFocusedTabByIndex || <syntaxhighlight lang="c++" inline>int alIdx</syntaxhighlight> ||
|-
...
|-
| <syntaxhighlight lang="c++" inline>void</syntaxhighlight> || SetForegroundZ || <syntaxhighlight lang="c++" inline>float afZ</syntaxhighlight> ||
|-
