...
==Fields==
cWidgetCollapsiblePaneContainer has no public fields.

==Functions==
{{CodeDocSummaryTop|Return Type|Function And Description}}
{{CodeDocSummaryItem|[[../cWidgetCollapsiblePane|cWidgetCollapsiblePane]]|[[#AddPane|AddPane]](const [[../tWString|tWString]] &in asLabel)|}}
...
==Details==
{{CodeDocDetailTop|AddPane}}
<syntaxhighlight lang="c++">cWidgetCollapsiblePane@ AddPane(const tWString &in asLabel)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|asLabel|[[../tWString|tWString]]|}}
{{CodeDocDetailReturn|cWidgetCollapsiblePane@|}}
{{CodeDocDetailBottom}}
