...
==Fields==
cLightDirectional has no public fields.
...
{{CodeDocSummaryItem|float|[[#GetAutoShadowSliceLogTerm|GetAutoShadowSliceLogTerm]]()|}}
{{CodeDocSummaryItem|bool|[[#GetAutoShadowSliceSettings|GetAutoShadowSliceSettings]]()|}}
...
{{CodeDocSummaryItem|[[../cVector3f|cVector3f]]|[[#GetDirection|GetDirection]]()|}}
...
{{CodeDocSummaryItem|float|[[#GetShadowCasterDistance|GetShadowCasterDistance]]()|}}
{{CodeDocSummaryItem|int|[[#GetShadowCastersAffected|GetShadowCastersAffected]]()|}}
{{CodeDocSummaryItem|float|[[#GetShadowDistance|GetShadowDistance]]()|}}
...
{{CodeDocSummaryItem|[[../cLightDirectional_ShadowSlice|cLightDirectional_ShadowSlice]]|[[#GetShadowSliceProperties|GetShadowSliceProperties]](int alIdx)|}}
...
{{CodeDocSummaryItem|void|[[#SetAutoShadowSliceLogTerm|SetAutoShadowSliceLogTerm]](float afX)|}}
{{CodeDocSummaryItem|void|[[#SetAutoShadowSliceSettings|SetAutoShadowSliceSettings]](bool abX)|}}
...
{{CodeDocSummaryItem|void|[[#SetDirection|SetDirection]](const [[../cVector3f|cVector3f]] &in avDir)|}}
...
{{CodeDocSummaryItem|void|[[#SetShadowCasterDistance|SetShadowCasterDistance]](float afX)|}}
{{CodeDocSummaryItem|void|[[#SetShadowCastersAffected|SetShadowCastersAffected]](int alX)|}}
{{CodeDocSummaryItem|void|[[#SetShadowDistance|SetShadowDistance]](float afX)|}}
...
{{CodeDocDetailTop|GetAutoShadowSliceLogTerm}}
<syntaxhighlight lang="c++">float GetAutoShadowSliceLogTerm()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetAutoShadowSliceSettings}}
<syntaxhighlight lang="c++">bool GetAutoShadowSliceSettings()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetDirection}}
<syntaxhighlight lang="c++">const cVector3f& GetDirection()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetShadowCasterDistance}}
<syntaxhighlight lang="c++">float GetShadowCasterDistance()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetShadowDistance}}
<syntaxhighlight lang="c++">float GetShadowDistance()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetShadowSliceProperties}}
<syntaxhighlight lang="c++">cLightDirectional_ShadowSlice@ GetShadowSliceProperties(int alIdx)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alIdx|int|}}
{{CodeDocDetailReturn|cLightDirectional_ShadowSlice@|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetAutoShadowSliceLogTerm}}
<syntaxhighlight lang="c++">void SetAutoShadowSliceLogTerm(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetAutoShadowSliceSettings}}
<syntaxhighlight lang="c++">void SetAutoShadowSliceSettings(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
<syntaxhighlight lang="c++">void SetDirection(const cVector3f &in avDir)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetShadowCasterDistance}}
<syntaxhighlight lang="c++">void SetShadowCasterDistance(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetShadowDistance}}
<syntaxhighlight lang="c++">void SetShadowDistance(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
