...
{{CodeDocSummaryItem|[[../cBeamEnd|cBeamEnd]]|[[#GetEnd|GetEnd]]()|}}
...
{{CodeDocSummaryItem|[[../cVector3f|cVector3f]]|[[#GetMidPosition|GetMidPosition]]()|}}
...
{{CodeDocSummaryItem|bool|[[#GetTileHeight|GetTileHeight]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetBrightness|SetBrightness]](float afBrightness)|}}
...
{{CodeDocSummaryItem|void|[[#SetTileHeight|SetTileHeight]](bool abX)|}}
...
<syntaxhighlight lang="c++">cVector3f GetAxis()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetEnd}}
<syntaxhighlight lang="c++">cBeamEnd@ GetEnd()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|cBeamEnd@|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetMidPosition}}
<syntaxhighlight lang="c++">cVector3f GetMidPosition()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|cVector3f|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetTileHeight}}
<syntaxhighlight lang="c++">bool GetTileHeight()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
<syntaxhighlight lang="c++">void SetBrightness(float afBrightness)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetTileHeight}}
<syntaxhighlight lang="c++">void SetTileHeight(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
