...
{{CodeDocSummaryItem|void|[[#SetMaxDistance|SetMaxDistance]](float afX)|}}
{{CodeDocSummaryItem|void|[[#SetMaxLimitSound|SetMaxLimitSound]](const [[../tString|tString]] &in asSound, float afMinSpeed)|}}
{{CodeDocSummaryItem|void|[[#SetMinDistance|SetMinDistance]](float afX)|}}
...
<syntaxhighlight lang="c++">void SetMaxDistance(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
<syntaxhighlight lang="c++">void SetMinDistance(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
