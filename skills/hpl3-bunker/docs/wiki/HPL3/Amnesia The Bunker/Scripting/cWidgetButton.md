...
==Fields==
cWidgetButton has no public fields.
...
{{CodeDocSummaryItem|[[../cGuiGfxElement|cGuiGfxElement]]|[[#GetImage|GetImage]]()|}}
...
{{CodeDocSummaryItem|bool|[[#GetRepeatActive|GetRepeatActive]]()|}}
...
{{CodeDocSummaryItem|bool|[[#IsPressed|IsPressed]]()|}}
{{CodeDocSummaryItem|bool|[[#IsRightUnderMouse|IsRightUnderMouse]]()|}}
{{CodeDocSummaryItem|bool|[[#IsToggleable|IsToggleable]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetImage|SetImage]]([[../cGuiGfxElement|cGuiGfxElement@]] apImage, bool abDestroyImage <nowiki>=</nowiki> true)|}}
...
{{CodeDocSummaryItem|void|[[#SetPressed|SetPressed]](bool abX, bool abGenCallback <nowiki>=</nowiki> true)|}}
{{CodeDocSummaryItem|void|[[#SetRepeatActive|SetRepeatActive]](bool abX)|}}
{{CodeDocSummaryItem|void|[[#SetRepeatFreq|SetRepeatFreq]](float afFreq)|}}
...
{{CodeDocSummaryItem|void|[[#SetToggleable|SetToggleable]](bool abX)|}}
...
{{CodeDocDetailTop|GetImage}}
<syntaxhighlight lang="c++">cGuiGfxElement@ GetImage()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetRepeatActive}}
<syntaxhighlight lang="c++">bool GetRepeatActive()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|IsPressed}}
<syntaxhighlight lang="c++">bool IsPressed()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|IsToggleable}}
<syntaxhighlight lang="c++">bool IsToggleable()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetImage}}
<syntaxhighlight lang="c++">void SetImage(cGuiGfxElement@ apImage,
              bool abDestroyImage = true)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|apImage|[[../cGuiGfxElement|cGuiGfxElement@]]|}}
{{CodeDocDetailParam|abDestroyImage|bool|}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetPressed}}
<syntaxhighlight lang="c++">void SetPressed(bool abX,
...
{{CodeDocDetailTop|SetRepeatActive}}
<syntaxhighlight lang="c++">void SetRepeatActive(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetRepeatFreq}}
<syntaxhighlight lang="c++">void SetRepeatFreq(float afFreq)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetToggleable}}
<syntaxhighlight lang="c++">void SetToggleable(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
