...
==Fields==
cWidgetSlider has no public fields.
...
{{CodeDocSummaryItem|int|[[#GetBarClickValueAdd|GetBarClickValueAdd]]()|}}
{{CodeDocSummaryItem|int|[[#GetBarValueSize|GetBarValueSize]]()|}}
{{CodeDocSummaryItem|float|[[#GetButtonSize|GetButtonSize]]()|}}
{{CodeDocSummaryItem|int|[[#GetButtonValueAdd|GetButtonValueAdd]]()|}}
...
{{CodeDocSummaryItem|int|[[#GetMaxValue|GetMaxValue]]()|}}
...
{{CodeDocSummaryItem|int|[[#GetValue|GetValue]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetBarClickValueAdd|SetBarClickValueAdd]](int alAdd)|}}
{{CodeDocSummaryItem|void|[[#SetBarValueSize|SetBarValueSize]](int alSize)|}}
{{CodeDocSummaryItem|void|[[#SetButtonValueAdd|SetButtonValueAdd]](int alAdd)|}}
...
{{CodeDocSummaryItem|void|[[#SetMaxValue|SetMaxValue]](int alMax)|}}
...
{{CodeDocSummaryItem|void|[[#SetValue|SetValue]](int alValue, bool abGenCallback <nowiki>=</nowiki> true)|}}
...
{{CodeDocDetailTop|GetBarClickValueAdd}}
<syntaxhighlight lang="c++">int GetBarClickValueAdd()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetBarValueSize}}
<syntaxhighlight lang="c++">int GetBarValueSize()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetButtonSize}}
<syntaxhighlight lang="c++">float GetButtonSize()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetButtonValueAdd}}
<syntaxhighlight lang="c++">int GetButtonValueAdd()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetMaxValue}}
<syntaxhighlight lang="c++">int GetMaxValue()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
<syntaxhighlight lang="c++">int GetValue()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetBarClickValueAdd}}
<syntaxhighlight lang="c++">void SetBarClickValueAdd(int alAdd)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alAdd|int|}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|SetBarValueSize}}
<syntaxhighlight lang="c++">void SetBarValueSize(int alSize)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetButtonValueAdd}}
<syntaxhighlight lang="c++">void SetButtonValueAdd(int alAdd)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alAdd|int|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetMaxValue}}
<syntaxhighlight lang="c++">void SetMaxValue(int alMax)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
<syntaxhighlight lang="c++">void SetValue(int alValue,
              bool abGenCallback = true)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alValue|int|}}
{{CodeDocDetailParam|abGenCallback|bool|}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
