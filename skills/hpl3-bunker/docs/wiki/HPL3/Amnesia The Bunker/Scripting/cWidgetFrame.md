...
{{CodeDocSummaryItem|bool|[[#GetDrawFrame|GetDrawFrame]]()|}}
...
{{CodeDocSummaryItem|void|[[#ScrollToPosition|ScrollToPosition]](const [[../cVector2f|cVector2f]] &in avPos)|}}
...
{{CodeDocSummaryItem|void|[[#SetDrawFrame|SetDrawFrame]](bool abX)|}}
...
{{CodeDocDetailTop|GetDrawFrame}}
<syntaxhighlight lang="c++">bool GetDrawFrame()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|ScrollToPosition}}
<syntaxhighlight lang="c++">void ScrollToPosition(const cVector2f &in avPos)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetDrawFrame}}
<syntaxhighlight lang="c++">void SetDrawFrame(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
