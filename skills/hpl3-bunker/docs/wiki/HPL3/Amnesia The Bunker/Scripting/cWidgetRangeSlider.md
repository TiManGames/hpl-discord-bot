...
{{CodeDocSummaryItem|bool|[[#GetAllowLimitPushing|GetAllowLimitPushing]]()|}}
...
{{CodeDocSummaryItem|int|[[#GetMinValue|GetMinValue]]()|}}
...
{{CodeDocSummaryItem|int|[[#GetRangeStart|GetRangeStart]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetAllowLimitPushing|SetAllowLimitPushing]](bool abX)|}}
...
{{CodeDocSummaryItem|void|[[#SetMaxValue|SetMaxValue]](int alValue)|}}
{{CodeDocSummaryItem|void|[[#SetMinValue|SetMinValue]](int alValue)|}}
...
{{CodeDocSummaryItem|void|[[#SetRangeEnd|SetRangeEnd]](int alValue)|}}
{{CodeDocSummaryItem|int|[[#SetRangeEnd|SetRangeEnd]]()|}}
{{CodeDocSummaryItem|void|[[#SetRangeStart|SetRangeStart]](int alValue)|}}
...
{{CodeDocDetailTop|GetAllowLimitPushing}}
<syntaxhighlight lang="c++">bool GetAllowLimitPushing()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetMinValue}}
<syntaxhighlight lang="c++">int GetMinValue()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetRangeStart}}
<syntaxhighlight lang="c++">int GetRangeStart()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetAllowLimitPushing}}
<syntaxhighlight lang="c++">void SetAllowLimitPushing(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
...
<syntaxhighlight lang="c++">void SetMaxValue(int alValue)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetMinValue}}
<syntaxhighlight lang="c++">void SetMinValue(int alValue)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alValue|int|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetRangeEnd}}
<syntaxhighlight lang="c++">void SetRangeEnd(int alValue)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alValue|int|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetRangeEnd}}
<syntaxhighlight lang="c++">int SetRangeEnd()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|SetRangeStart}}
<syntaxhighlight lang="c++">void SetRangeStart(int alValue)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alValue|int|}}
{{CodeDocDetailReturn|void|}}
