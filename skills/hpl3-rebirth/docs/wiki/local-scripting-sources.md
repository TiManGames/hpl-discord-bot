...
- RebirthFunny map passes: read `.codex/skills/hpl3-modder/references/rebirthfunny-development.md` before editing `mods/RebirthFunny`.
- Rebirth `.voice` source pass: use `.codex/skills/hpl3-modder/scripts/extract_voice_lines.ps1` to make a compact line/callback index before choosing or editing voice callbacks; still edit the original `.voice` file when callback attributes need to be added.
