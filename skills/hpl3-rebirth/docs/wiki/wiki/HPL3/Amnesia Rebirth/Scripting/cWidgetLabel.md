...
==Fields==
cWidgetLabel has no public fields.
...
{{CodeDocSummaryItem|bool|[[#GetAutogenerateSize|GetAutogenerateSize]]()|}}
{{CodeDocSummaryItem|[[../cColor|cColor]]|[[#GetBackGroundColor|GetBackGroundColor]]()|}}
...
{{CodeDocSummaryItem|bool|[[#GetDrawBackGround|GetDrawBackGround]]()|}}
...
{{CodeDocSummaryItem|int|[[#GetMaxTextLength|GetMaxTextLength]]()|}}
...
{{CodeDocSummaryItem|float|[[#GetScrollSpeedMul|GetScrollSpeedMul]]()|}}
{{CodeDocSummaryItem|float|[[#GetScrollWaitTime|GetScrollWaitTime]]()|}}
...
{{CodeDocSummaryItem|[[../eFontAlign|eFontAlign]]|[[#GetTextAlign|GetTextAlign]]()|}}
...
{{CodeDocSummaryItem|bool|[[#GetWordWrap|GetWordWrap]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetAutogenerateSize|SetAutogenerateSize]](bool abX)|}}
{{CodeDocSummaryItem|void|[[#SetBackGroundColor|SetBackGroundColor]](const [[../cColor|cColor]] &in aColor)|}}
...
{{CodeDocSummaryItem|void|[[#SetDrawBackGround|SetDrawBackGround]](bool abX)|}}
...
{{CodeDocSummaryItem|void|[[#SetMaxTextLength|SetMaxTextLength]](int alLength)|}}
...
{{CodeDocSummaryItem|void|[[#SetScrollOffset|SetScrollOffset]](float afX)|}}
{{CodeDocSummaryItem|void|[[#SetScrollSpeedMul|SetScrollSpeedMul]](float afX)|}}
{{CodeDocSummaryItem|void|[[#SetScrollWaitTime|SetScrollWaitTime]](float afX)|}}
...
{{CodeDocSummaryItem|void|[[#SetTextAlign|SetTextAlign]]([[../eFontAlign|eFontAlign]] aType)|}}
...
{{CodeDocSummaryItem|void|[[#SetWordWrap|SetWordWrap]](bool abX)|}}
...
{{CodeDocDetailTop|GetAutogenerateSize}}
<syntaxhighlight lang="c++">bool GetAutogenerateSize()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetBackGroundColor}}
<syntaxhighlight lang="c++">const cColor& GetBackGroundColor()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetDrawBackGround}}
<syntaxhighlight lang="c++">bool GetDrawBackGround()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetMaxTextLength}}
<syntaxhighlight lang="c++">int GetMaxTextLength()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetScrollSpeedMul}}
<syntaxhighlight lang="c++">float GetScrollSpeedMul()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetScrollWaitTime}}
<syntaxhighlight lang="c++">float GetScrollWaitTime()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetTextAlign}}
<syntaxhighlight lang="c++">eFontAlign GetTextAlign()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|eFontAlign|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetWordWrap}}
<syntaxhighlight lang="c++">bool GetWordWrap()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetAutogenerateSize}}
<syntaxhighlight lang="c++">void SetAutogenerateSize(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetBackGroundColor}}
<syntaxhighlight lang="c++">void SetBackGroundColor(const cColor &in aColor)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetDrawBackGround}}
<syntaxhighlight lang="c++">void SetDrawBackGround(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetMaxTextLength}}
<syntaxhighlight lang="c++">void SetMaxTextLength(int alLength)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alLength|int|}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetScrollOffset}}
<syntaxhighlight lang="c++">void SetScrollOffset(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetScrollSpeedMul}}
<syntaxhighlight lang="c++">void SetScrollSpeedMul(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetScrollWaitTime}}
<syntaxhighlight lang="c++">void SetScrollWaitTime(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetTextAlign}}
<syntaxhighlight lang="c++">void SetTextAlign(eFontAlign aType)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|aType|[[../eFontAlign|eFontAlign]]|}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetWordWrap}}
<syntaxhighlight lang="c++">void SetWordWrap(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
