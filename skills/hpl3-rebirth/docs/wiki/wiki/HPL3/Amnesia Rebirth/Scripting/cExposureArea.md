...
{{CodeDocSummaryItem|void|[[#ConnectExposureAreaWindow|ConnectExposureAreaWindow]]([[../cExposureArea|cExposureArea@]] apWindow)|}}
...
{{CodeDocSummaryItem|float|[[#GetExposure|GetExposure]](float afX)|}}
...
{{CodeDocSummaryItem|float|[[#GetTransitionTime|GetTransitionTime]](float afX)|}}
{{CodeDocSummaryItem|int|[[#GetUniqueID|GetUniqueID]]()|}}
{{CodeDocSummaryItem|float|[[#GetWhiteCut|GetWhiteCut]](float afX)|}}
...
{{CodeDocSummaryItem|void|[[#SetExposure|SetExposure]](float afX)|}}
...
{{CodeDocSummaryItem|void|[[#SetTransitionTime|SetTransitionTime]](float afX)|}}
{{CodeDocSummaryItem|void|[[#SetWhiteCut|SetWhiteCut]](float afX)|}}
...
{{CodeDocDetailTop|ConnectExposureAreaWindow}}
<syntaxhighlight lang="c++">void ConnectExposureAreaWindow(cExposureArea@ apWindow)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|apWindow|[[../cExposureArea|cExposureArea@]]|}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
...
<syntaxhighlight lang="c++">float GetExposure(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
<syntaxhighlight lang="c++">float GetTransitionTime(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|float|}}
...
{{CodeDocDetailTop|GetWhiteCut}}
<syntaxhighlight lang="c++">float GetWhiteCut(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|float|}}
...
{{CodeDocDetailTop|SetExposure}}
<syntaxhighlight lang="c++">void SetExposure(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetTransitionTime}}
<syntaxhighlight lang="c++">void SetTransitionTime(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetWhiteCut}}
<syntaxhighlight lang="c++">void SetWhiteCut(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
