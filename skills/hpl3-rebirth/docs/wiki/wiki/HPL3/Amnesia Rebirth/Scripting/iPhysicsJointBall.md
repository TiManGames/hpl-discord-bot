...
{{CodeDocSummaryItem|[[../cVector3f|cVector3f]]|[[#GetAngles|GetAngles]]()|}}
...
{{CodeDocSummaryItem|float|[[#GetMaxConeAngle|GetMaxConeAngle]]()|}}
{{CodeDocSummaryItem|float|[[#GetMaxTwistAngle|GetMaxTwistAngle]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetConeLimits|SetConeLimits]](float afMaxConeAngle, float afMaxTwistAngle)|}}
...
{{CodeDocDetailTop|GetAngles}}
<syntaxhighlight lang="c++">cVector3f GetAngles()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetMaxConeAngle}}
<syntaxhighlight lang="c++">float GetMaxConeAngle()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetMaxTwistAngle}}
<syntaxhighlight lang="c++">float GetMaxTwistAngle()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetConeLimits}}
<syntaxhighlight lang="c++">void SetConeLimits(float afMaxConeAngle,
                   float afMaxTwistAngle)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afMaxConeAngle|float|}}
{{CodeDocDetailParam|afMaxTwistAngle|float|}}
{{CodeDocDetailReturn|void|}}
{{CodeDocDetailBottom}}
