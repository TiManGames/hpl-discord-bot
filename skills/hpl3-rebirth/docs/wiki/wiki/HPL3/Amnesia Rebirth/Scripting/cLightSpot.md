...
==Fields==
cLightSpot has no public fields.
...
{{CodeDocSummaryItem|float|[[#GetCosHalfFOV|GetCosHalfFOV]]()|}}
...
{{CodeDocSummaryItem|float|[[#GetSpotFalloffPow|GetSpotFalloffPow]]()|}}
{{CodeDocSummaryItem|float|[[#GetTanHalfFOV|GetTanHalfFOV]]()|}}
...
{{CodeDocSummaryItem|[[../cMatrixf|cMatrixf]]|[[#GetViewProjMatrix|GetViewProjMatrix]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetAspect|SetAspect]](float afAngle)|}}
...
{{CodeDocSummaryItem|void|[[#SetSpotFalloffPow|SetSpotFalloffPow]](float afX)|}}
...
{{CodeDocDetailTop|GetCosHalfFOV}}
<syntaxhighlight lang="c++">float GetCosHalfFOV()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetSpotFalloffPow}}
<syntaxhighlight lang="c++">float GetSpotFalloffPow()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetTanHalfFOV}}
<syntaxhighlight lang="c++">float GetTanHalfFOV()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetViewProjMatrix}}
<syntaxhighlight lang="c++">const cMatrixf& GetViewProjMatrix()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|const cMatrixf&|}}
{{CodeDocDetailBottom}}
...
<syntaxhighlight lang="c++">void SetAspect(float afAngle)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetSpotFalloffPow}}
<syntaxhighlight lang="c++">void SetSpotFalloffPow(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
