...
{{CodeDocSummaryItem|int|[[#GetMaxSegmentNum|GetMaxSegmentNum]]()|}}
{{CodeDocSummaryItem|[[../tString|tString]]|[[#GetName|GetName]]()|}}
{{CodeDocSummaryItem|[[../iPhysicsRope|iPhysicsRope]]|[[#GetPhysicsRope|GetPhysicsRope]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetMaxSegmentNum|SetMaxSegmentNum]](int alX)|}}
...
{{CodeDocSummaryItem|void|[[#SetRingSegmentNum|SetRingSegmentNum]](int alX)|}}
{{CodeDocSummaryItem|void|[[#SetScriptableIsSaved|SetScriptableIsSaved]](bool abX)|}}
{{CodeDocSummaryItem|void|[[#SetTextureSize|SetTextureSize]]([[../cVector2f|cVector2f]] avX)|}}
{{CodeDocSummaryItem|void|[[#SetUVScale|SetUVScale]](float afX)|}}
...
{{CodeDocDetailTop|GetMaxSegmentNum}}
<syntaxhighlight lang="c++">int GetMaxSegmentNum()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetPhysicsRope}}
<syntaxhighlight lang="c++">iPhysicsRope@ GetPhysicsRope()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetRingSegmentNum}}
<syntaxhighlight lang="c++">int GetRingSegmentNum()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetTextureSize}}
<syntaxhighlight lang="c++">cVector2f GetTextureSize()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetUVScale}}
<syntaxhighlight lang="c++">float GetUVScale()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|float|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetMaxSegmentNum}}
<syntaxhighlight lang="c++">void SetMaxSegmentNum(int alX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetRingSegmentNum}}
<syntaxhighlight lang="c++">void SetRingSegmentNum(int alX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alX|int|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetTextureSize}}
<syntaxhighlight lang="c++">void SetTextureSize(cVector2f avX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetUVScale}}
<syntaxhighlight lang="c++">void SetUVScale(float afX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|afX|float|}}
{{CodeDocDetailReturn|void|}}
