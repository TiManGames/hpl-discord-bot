...
==Fields==
cWidgetMultiPropertyListBox has no public fields.

==Functions==
{{CodeDocSummaryTop|Return Type|Function And Description}}
{{CodeDocSummaryItem|void|[[#AddColumn|AddColumn]](const [[../tString|tString]] &in asName, const int alIndex, [[../eFontAlign|eFontAlign]] aAlign <nowiki>=</nowiki> eFontAlign_Left)|}}
...
{{CodeDocSummaryItem|float|[[#GetColumnWidth|GetColumnWidth]](int alIdx)|}}
...
{{CodeDocSummaryItem|[[../cVector3f|cVector3f]]|[[#GetItemPosOnList|GetItemPosOnList]]([[../cWidgetItem|cWidgetItem@]] apItem, int alColumn)|}}
{{CodeDocSummaryItem|[[../cVector3f|cVector3f]]|[[#GetItemStartPos|GetItemStartPos]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetColumnWidth|SetColumnWidth]](const int alIdx, float afWidth)|}}
...
==Details==
{{CodeDocDetailTop|AddColumn}}
<syntaxhighlight lang="c++">void AddColumn(const tString &in asName,
               const int alIndex,
               eFontAlign aAlign = eFontAlign_Left)</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetColumnWidth}}
<syntaxhighlight lang="c++">float GetColumnWidth(int alIdx)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|GetItemPosOnList}}
<syntaxhighlight lang="c++">cVector3f GetItemPosOnList(cWidgetItem@ apItem,
                           int alColumn)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|apItem|[[../cWidgetItem|cWidgetItem@]]|}}
{{CodeDocDetailParam|alColumn|int|}}
{{CodeDocDetailReturn|cVector3f|}}
{{CodeDocDetailBottom}}

{{CodeDocDetailTop|GetItemStartPos}}
<syntaxhighlight lang="c++">cVector3f GetItemStartPos()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|cVector3f|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetColumnWidth}}
<syntaxhighlight lang="c++">void SetColumnWidth(const int alIdx,
                    float afWidth)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alIdx|int|}}
