...
{{CodeDocSummaryItem|bool|[[#GetCanEdit|GetCanEdit]]()|}}
...
{{CodeDocSummaryItem|int|[[#GetMaxShownItems|GetMaxShownItems]]()|}}
...
{{CodeDocSummaryItem|int|[[#GetSelectedItem|GetSelectedItem]]()|}}
...
{{CodeDocSummaryItem|void|[[#SetCanEdit|SetCanEdit]](bool abX)|}}
...
{{CodeDocSummaryItem|void|[[#SetMaxShownItems|SetMaxShownItems]](int alX)|}}
...
{{CodeDocSummaryItem|void|[[#SetSelectedItem|SetSelectedItem]](int alX, bool abMoveList <nowiki>=</nowiki> false, bool abGenCallback <nowiki>=</nowiki> true)|}}
...
{{CodeDocDetailTop|GetCanEdit}}
<syntaxhighlight lang="c++">bool GetCanEdit()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|bool|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|GetMaxShownItems}}
<syntaxhighlight lang="c++">int GetMaxShownItems()</syntaxhighlight>
{{CodeDocDetailBody|}}
...
{{CodeDocDetailTop|GetSelectedItem}}
<syntaxhighlight lang="c++">int GetSelectedItem()</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailReturn|int|}}
{{CodeDocDetailBottom}}
...
{{CodeDocDetailTop|SetCanEdit}}
<syntaxhighlight lang="c++">void SetCanEdit(bool abX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|abX|bool|}}
{{CodeDocDetailReturn|void|}}
...
{{CodeDocDetailTop|SetMaxShownItems}}
<syntaxhighlight lang="c++">void SetMaxShownItems(int alX)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
...
{{CodeDocDetailTop|SetSelectedItem}}
<syntaxhighlight lang="c++">void SetSelectedItem(int alX,
                     bool abMoveList = false,
                     bool abGenCallback = true)</syntaxhighlight>
{{CodeDocDetailBody|}}
{{CodeDocDetailParamStart}}
{{CodeDocDetailParam|alX|int|}}
{{CodeDocDetailParam|abMoveList|bool|}}
